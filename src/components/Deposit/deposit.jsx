...
import { getAccounts, deposit } from "../../services/bankingService";
...
const Deposit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await deposit(selectedAccount, parseFloat(amount));
      setSuccess(true);
      setAmount("");
      setSelectedAccount("");
      ...
      setError("Failed to complete the deposit. Please try again.");
    } finally {
      setLoading(false);
    }
  };
